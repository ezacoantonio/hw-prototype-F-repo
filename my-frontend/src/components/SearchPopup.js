    ...
    <Dialog open={open} onClose={onClose}>
      ...
      <DialogContent>
        <TireSizeAutocomplete
          onSizeSelect={(size) => setSearchParams({ ...searchParams, size })}
        />
        <TireBrandAutocomplete
          onBrandSelect={(brand) => setSearchParams({ ...searchParams, brand })}
        />
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            ...
            onChange={(e) =>
              setSearchParams({ ...searchParams, sortOrder: e.target.value })
            }
            label="Order"
          >
